...
namespace SimpleNotificationSystem.UI
{
    internal class UserInterface
    {
        ...
        public void Start()
        {
            ...
            while (true)
            {
                ...
                switch (choice)
                {
                    ...
                    case "2": SendNotificationMenu(); break;
                    case "3":
        ...
        private void SendNotificationMenu()
        {
            ...
            {
                case "1":
                    _emailService.SendNotification(user.Email, message);
                    break;
                case "2":
                    _smsService.SendNotification(user.Phone.CountryCode + user.Phone.Number, message);
                    break;
                default:
